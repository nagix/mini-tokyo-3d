...
Le point de vue en mode suivi peut être modifié dans le panneau Paramètres du mode suivi. Voir [here](./configuration.md#tracking-mode-settings) pour plus de détails.