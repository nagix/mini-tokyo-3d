...
Public Transportation Open Data Center<br>([Open Data Challenge for Public Transportation 2026](https://challenge2026.odpt.org/index-e.html)) | [Link](https://developer.odpt.org/signup) | A string of numbers and lowercase letters
...
### Getting an Access Token for Open Data Challenge for Public Transportation 2026

The Public Transportation Open Data Center is also distributing additional train and airplane data for the [Open Data Challenge for Public Transportation 2026](https://challenge2026.odpt.org/index-e.html), which can be obtained with a dedicated access token. You need to enter the challenge to get your dedicated access token, but the data is available for free.
...
2. Select "Access Token for Challenge 2026" from the menu shown "Logged in" in the upper right corner of the screen.
3. A list of access tokens for Challenge 2026 will be displayed. Only the "Challenge2026DefaultApplication" token will be displayed right after entry. Click on "Add".
4. Enter an application name in the "Name" field and click the "Update" button.
5. The newly created token will appear in the list of access tokens.
  ...
  <script>
    const options = {
      ...
      secrets: {
        ...
        challenge: '<access token for Open Data Challenge for Public Transportation 2026>'
      }
    };
