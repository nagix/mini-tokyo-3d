...
export default class extends Evented {
    ...
    // properties.group values ('<ids[0]>.og' vs '<ids[0]>.ug') - so marking
    // one only fetches that layer's own feature. Fetching the other layer's
    // group too and combining both into one FeatureCollection restores the
    // pre-glow behavior (see this method before ef0bb80a), where marking
    // either side highlighted both.
